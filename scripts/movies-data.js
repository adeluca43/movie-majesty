//define an array called movies, contains objects representing movies, properties are title,poster, description
// export sends it to other files no need to module.exports at the bottom now
export const movies = [
    {
        title: "Inception",
